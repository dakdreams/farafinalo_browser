      ...
      <Tab.Pane>
        <Grid columns={4}>
          <Grid.Row>
            ...
            <Grid.Column>
              <Image src="https://cdn.maisonsdumonde.com/img/meuble-tv-vintage-2-portes-1-tiroir-700-14-37-155632_2.jpg" size="medium" wrapped />
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Tab.Pane>
      ...
      <Tab.Pane>
        ...
        <Grid columns={4}>
          <Grid.Row>
            ...
            <Grid.Column>
              <Image src="https://static.vecteezy.com/system/resources/previews/000/148/628/non_2x/men-fashion-icon-pack-vector.jpg" size="medium" wrapped />
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Tab.Pane>
      ...
      <Tab.Pane>
        ...
        <Grid columns={4}>
          <Grid.Row>
            ...
            <Grid.Column>
              <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8QU2l-uo4JukqUl6RJ1n8esSyvehLLz58rSWBMOpvI1Q1qNjwsw" size="medium" wrapped />
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Tab.Pane>
